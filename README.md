...
**[Use it in your browser](https://911-parth.github.io/receipt-scanner/)** — scan receipts and keep an expense log, all client-side with tesseract.js. Nothing gets uploaded, the log lives in your browser storage.
